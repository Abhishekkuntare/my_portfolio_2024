...
import ch1 from "../assets/works/ch/ch1.png";
import ch2 from "../assets/works/ch/ch2.png";
import ch3 from "../assets/works/ch/ch3.png";

import gi1 from "../assets/works/gi/gi1.png";
import gi2 from "../assets/works/gi/gi2.png";
import gi3 from "../assets/works/gi/gi3.png";
import gi4 from "../assets/works/gi/gi4.png";
import gi5 from "../assets/works/gi/gi5.png";

import map1 from "../assets/works/map/map1.png";
import map2 from "../assets/works/map/map2.png";
import map3 from "../assets/works/map/map3.png";
import map4 from "../assets/works/map/map4.png";
import map5 from "../assets/works/map/map5.png";
import map6 from "../assets/works/map/map6.png";
...
const projects = [
  ...
  },
  {
    ...
    img5: ch2,
    img6: ch2,
    stack: "#MERN,#APIs,#Socket.io,#Postman,#Render",
    title: "Chat App ",
    desc: "Real-time chat app powered by MERN stack and Socket.IO for seamless communication. Experience instant messaging with lightning-fast updates and a dynamic interface!",
    website: "https://chatapp-0h5v.onrender.com/login",
    code: "https://github.com/Abhishekkuntare/chatapp",
    prev: "/",
  },
  {
    link: "github",
    ...
    img5: gi5,
    img6: gi1,
    stack: "#MERN,#APIs,#Passport.js,#Postman,#Render",
    title: "Gihub-Clone ",
    desc: "I proudly showcase my project, a GitHub clone built with the MERN stack (MongoDB, Express.js, React.js, Node.js) and integrated authentication using Passport.js. This project demonstrates my proficiency in full-stack development, including database management, server-side scripting, and front-end design. With a focus on replicating key functionalities of the original GitHub platform, such as user authentication and repository management, this project highlights my ability to create robust and scalable web applications using modern technologies.",
    website: "https://github-clone-6ft5.onrender.com/",
    code: "https://github.com/Abhishekkuntare/github-clone",
    prev: "/",
  },
  {
    link: "maps",
    ...
    img5: map5,
    img6: map6,
    stack: "#React.js,#Next.js,#Leaflet.js,#Algolia,#Vercel",
    title: "Maps",
    desc: "Welcome to the dynamic map interface of Maps, designed for easy location exploration. The main screen features a map with a top-left, Algolia-powered search bar for real-time suggestions. Selecting a suggestion recenters the map to the chosen location, displaying detailed markers. • Maps’ frontend, powered by Next.js and Algolia, utilizes Leaflet for maps and MarkerClusterGroup for efficient clustering, ensuring a seamless user experience",
    website: "https://frontend-task-maps.vercel.app/",
    code: "https://github.com/Abhishekkuntare/FrontendTask-Maps",
    prev: "/",
  },
  {
    link: "blogme",
